...
('Аналитик 1-ой линии аглоцеха'), -- (видит только свою *1-ую* линию *агломерационного* цеха)
('Аналитик 2-ой линии аглоцеха'), -- (видит только свою *2-ую* линию *агломерационного* цеха)
...
(
    (SELECT job_title_id FROM job_titles WHERE job_title_name = 'Начальник аглоцеха'),
...
(
    (SELECT job_title_id FROM job_titles WHERE job_title_name = 'Аналитик 1-ой линии аглоцеха'),
    'Жмышенко', 'Валерий', 'Альбертович', 'valakas1488@mail.ru', '+79862754228',
    crypt('Гладиатор', gen_salt('bf')) -- пароль 'Гладиатор'
),
(
    (SELECT job_title_id FROM job_titles WHERE job_title_name = 'Аналитик 2-ой линии аглоцеха'),
...
inserted_actuators AS (
    ...
    FROM (VALUES
        ...
        ('Агломерационный цех', 'Первая'::line_types, 'Конвейер', 'Электродвигатель переменного тока (3ф)'),
        ...
        ('Агломерационный цех', 'Первая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)'),
        ...
        ('Агломерационный цех', 'Вторая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)'),
...
actuator_parameters_data(shop_name, line_enum, agg_type_name, act_type_name, param_type_name) AS (
   VALUES
        ...
        ('Агломерационный цех', 'Первая'::line_types, 'Конвейер', 'Электродвигатель переменного тока (3ф)', 'Электрический ток'),
        ('Агломерационный цех', 'Первая'::line_types, 'Конвейер', 'Электродвигатель переменного тока (3ф)', 'Температура сердечника статора'),
        ...
        ('Агломерационный цех', 'Первая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Электрический ток'),
        ('Агломерационный цех', 'Первая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Температура обмотки'),
        ('Агломерационный цех', 'Первая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Температура опорного подшипника'),
        ('Агломерационный цех', 'Первая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Вибрация опорного подшипника'),
        ...
        ('Агломерационный цех', 'Вторая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Электрический ток'),
        ('Агломерационный цех', 'Вторая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Температура обмотки'),
        ('Агломерационный цех', 'Вторая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Температура опорного подшипника'),
        ('Агломерационный цех', 'Вторая'::line_types, 'Эксгаустер', 'Электродвигатель переменного тока (3ф)', 'Вибрация опорного подшипника'),
